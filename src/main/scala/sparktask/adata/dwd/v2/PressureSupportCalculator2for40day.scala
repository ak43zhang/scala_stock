 ...
 */
object PressureSupportCalculator2for40day {
  // 在类顶部添加隐式排序定义
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputPath = "file:///D:\\gsdata\\gpsj_day_all_hs\\trade_date_month=20[14,15,16,17,18,19,20,21]*"
    val outputPath = "file:///D:\\gsdata\\pressure_support_calculator"
    val start_time = "2015-01-01"
    val end_time = "2016-07-28"
