...
object AdvancedDipStrategy {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder()
      ...
      .appName("AdvancedDipStrategy")
      .config("spark.sql.parquet.compression.codec", "snappy")  // 高性能压缩格式
    ...
    println("===== 低吸策略分析结果样例 =====")
    finalDF.where("trade_time='2025-02-07 00:00:00'").orderBy(col("channel_position")).show(20, truncate = false)  // 展示非截断结果
