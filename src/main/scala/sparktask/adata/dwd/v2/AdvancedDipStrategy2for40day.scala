 ...
 */
object AdvancedDipStrategy2for40day {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 阶段0：数据加载与清洗
    val stockDF  = spark.read.jdbc(url, "pressure_support_calculatorfor40_2025", properties)
      .union(spark.read.jdbc(url, "pressure_support_calculatorfor40_2024", properties))//23,24
      .union(spark.read.jdbc(url, "pressure_support_calculatorfor40_2022", properties))//21,22
